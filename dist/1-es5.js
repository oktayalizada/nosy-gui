...
var LoginHttpService = /** @class */ (function () {
    ...
    LoginHttpService.prototype.getToken = function (user) {
        return this.http.post(this.baseUrl + '/auth/token', user);
    };
    LoginHttpService.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(loginHttpService, router, globalService) {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        if (token != null && token.trim() != '') {
            this.globalService.isAuthenticated().subscribe(function (response) {
                if (response === true) {
    ...
    LoginComponent.prototype.onSignIn = function (f) {
        var _this = this;
        var email = f.value.email;
        var password = f.value.password;
        var user = new _user__WEBPACK_IMPORTED_MODULE_3__["User"](email, password);
        this.loginHttpService.getToken(user).subscribe(function (response) {
            _this.globalService.setLocalToken(response);
            _this.router.navigateByUrl('/dashboard');
        }, function (err) {
            _this.validUsername = true;
            _this.validUsernameMessage = err.error.message;
        });
    };
