...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.profileService.getProfileInfo().subscribe(function (data) {
            _this.profile = data;
        });
    };
