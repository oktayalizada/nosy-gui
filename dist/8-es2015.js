...
let InputSystemRoutingModule = class InputSystemRoutingModule {
};
...
let InputSystemComponent = class InputSystemComponent {
    constructor(nosyHttpService) {
    ...
    updateExistingSystem(updatedForm) {
        this.allFormReset();
        ...
        if (updatedForm['updateExistingInputSystemName'] === null || updatedForm['updateExistingInputSystemName'] === '') {
            ...
            this.nosyHttpService.updateExistingInputSystem(inputSystem).subscribe((response) => {
    ...
    deleteExistingSystem() {
        this.allFormReset();
        this.nosyHttpService.deleteExistingInputSystem(this.selectedInputSystemId).subscribe((response) => {
            this.firstForm('green', 'Input System ' + this.firstFormUpdatableInputSystem.name + ' deleted!', true);
            this.inputSystems.splice(this.inputSystems.indexOf(this.inputSystems.find(x => x.id === this.selectedInputSystemId)), 1);
            this.inputSystems = [...this.inputSystems];
        });
    }
    newInputSystem(inputSystemName) {
        if (inputSystemName === null || inputSystemName === '') {
            ...
            this.allFormReset();
            this.nosyHttpService.postInputSystemName(inputSystemName).subscribe((response) => {
...
InputSystemComponent.ctorParameters = () => [
...
let InputSystemModule = class InputSystemModule {
};
