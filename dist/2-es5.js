...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function (f) {
        var _this = this;
        this.registerService.register(new _register__WEBPACK_IMPORTED_MODULE_2__["Register"](f.value.email, f.value.firstName, f.value.lastName, f.value.password)).subscribe(function (data) {
