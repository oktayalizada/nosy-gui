...
var ManualEmailSenderRoutingModule = /** @class */ (function () {
    function ManualEmailSenderRoutingModule() {
    }
    ...
    return ManualEmailSenderRoutingModule;
}());
...
var ManualEmailSenderComponent = /** @class */ (function () {
    function ManualEmailSenderComponent(nosyHttpService, emailHttpService) {
        this.nosyHttpService = nosyHttpService;
        this.emailHttpService = emailHttpService;
    }
    ManualEmailSenderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.firstFormReset();
    ...
    ManualEmailSenderComponent.prototype.onChangeInputSystemFirstForm = function (event) {
        var _this = this;
    ...
    ManualEmailSenderComponent.prototype.onChangeEmailTemplateFirstForm = function (selectedEmailTemplate) {
        this.firstFormReset();
        this.selectedEmailTemplate = selectedEmailTemplate;
        this.isSelectedEmailTemplate = true;
    };
    ManualEmailSenderComponent.prototype.onClearInputSystem = function () {
        this.isSelectedEmailTemplate = false;
        this.isSelectedInputSystem = false;
    };
    ManualEmailSenderComponent.prototype.onClearEmailTemplate = function () {
        this.isSelectedEmailTemplate = false;
    };
    ManualEmailSenderComponent.prototype.firstForm = function (colour, message, isEnabled) {
        this.colourOperationsSend = colour;
        this.isOperationsSend = isEnabled;
        this.operationsSend = message;
    };
    ManualEmailSenderComponent.prototype.firstFormReset = function () {
        this.firstForm('', '', false);
    };
    ManualEmailSenderComponent.prototype.sendEmail = function () {
        var _this = this;
        this.firstFormReset();
        this.emailHttpService.postEmail(this.selectedEmailTemplateId, this.selectedInputSystemId, this.mailSender.value).subscribe(function (data) {
            _this.firstForm('green', 'Successfully Sent Email', true);
        }, function (err) {
            _this.firstForm('red', err.error, true);
        });
    };
    ManualEmailSenderComponent.prototype.addPlaceHolder = function () {
        this.firstFormReset();
    ...
    ManualEmailSenderComponent.prototype.onDeleteIngredient = function (index) {
        this.mailSender.get('placeholders').removeAt(-1);
    };
    ManualEmailSenderComponent.ctorParameters = function () { return [
    ...
    return ManualEmailSenderComponent;
}());
...
var ManualEmailSenderModule = /** @class */ (function () {
    function ManualEmailSenderModule() {
    }
    ...
    return ManualEmailSenderModule;
}());
